...
from .util import (avg_pool_nd, checkpoint, conv_nd, linear, normalization,
...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        use_new_attention_order=False,
        use_cross_attn=False,    # custom transformer support
        ...
        **ignore_kwargs
        ...
        if context_dim is not None:
            assert use_cross_attn, 'Fool!! You forgot to use the spatial transformer for your cross-attention conditioning...'
        ...
        for level, mult in enumerate(channel_mult):
            for _ in range(num_res_blocks):
                ...
                if ds in attention_resolutions:
                    ...
                    if legacy:
                        # num_heads = 1
                        dim_head = ch // num_heads if use_cross_attn else num_head_channels
                    layers.append(
                        AttentionBlock(
                            ch,
                            use_checkpoint=use_checkpoint,
                        ...
                        ) if not use_cross_attn else SpatialTransformer(
